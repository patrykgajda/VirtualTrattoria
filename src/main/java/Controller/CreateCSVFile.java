...
//    private static String[] columns = {"ClientNo", "ClientName", "PizzaName", "PizzaIngredients"};
    public static void createNewCSVFile(String filePath, ClientController client, ArrayList<Pizza> pizzaArrayList) throws FileNotFoundException {
...
//        writer.println(Arrays.toString(columns));
        for (Pizza pizza : pizzaArrayList) {
            ...
            writer.print(client.getClientName() + " ");
